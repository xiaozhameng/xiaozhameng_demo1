<%@ page contentType="text/html;charset=UTF-8" %><meta http-equiv="Content-Type" content="text/html;charset=utf-8" /><meta name="author" content="http://www.msyidai.com/"/>
...
<script type="text/javascript" src="${ctxStatic}/jquery/DateDiff.js"></script>
