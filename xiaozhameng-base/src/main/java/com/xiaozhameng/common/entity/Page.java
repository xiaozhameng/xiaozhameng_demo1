 ...
 */
package com.xiaozhameng.common.entity;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.xiaozhameng.common.utils.CookieUtils;
...
public class Page<T> implements java.io.Serializable{
	private static final long serialVersionUID = 2446026148328944353L;
	private int pageNo = 1; // 当前页码
	private int pageSize = 20;// 页面大小，设置为“-1”表示不进行分页（分页无效）
	
	private long count=-1;// 总记录数，设置为“-1”表示需要后面查询
