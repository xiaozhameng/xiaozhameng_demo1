 ...
 */
package com.xiaozhameng.mgmt.modules.act.service.ext;

import java.util.List;
import java.util.Map;

import com.xiaozhameng.mgmt.common.utils.SpringContextHolder;
import com.xiaozhameng.mgmt.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.xiaozhameng.mgmt.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.xiaozhameng.mgmt.modules.sys.entity.User(null, userId)))){
